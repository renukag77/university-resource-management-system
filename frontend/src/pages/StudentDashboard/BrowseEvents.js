  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh', display: 'flex' }}>
      ...
      <div style={{ flex: 1, marginLeft: '260px', padding: '40px' }}>
        ...
        <p style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '50px' }}>
          Explore all upcoming campus events and apply to your favorites
        </p>
        ...
        <div style={{
          ...
          <h3 style={{ marginTop: 0, marginBottom: '24px', fontSize: '1.25rem', fontWeight: '700', color: '#0f172a' }}>
            🔍 Search & Filter
          </h3>
                  ...
                  <div style={{ marginBottom: '16px', fontSize: '0.9rem' }}>
                    ...
                    {event.capacity && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#64748b' }}>
                        <span>🎟️</span>
                        <span style={{ fontWeight: '600', color: '#334155' }}>Capacity: {event.capacity}</span>
                      </div>
                    )}
                  </div>
